...
int main() {
    ...
    if (changeDue <= 0.009) cout << "Exact payment recieved - no change owed"; // 0.009 fixes double bug
    else cout << fixed << setprecision(2) << "Change due is $" << changeDue << " - ";
    changeDue = round(changeDue * 100); // converts cents to whole number, fixes double bug
    ...
    if (changeDue >= DIME_VALUE) {
        // Add comma for list
        if (numberQuarters > 0 || numberDollars > 0) cout << ", ";
    ...
    if (changeDue >= NICKEL_VALUE) {
        // Add comma for list
        if (numberDimes > 0 || numberQuarters > 0 || numberDollars > 0) cout << ", ";
    ...
    if (changeDue >= PENNY_VALUE) {
        // Add comma for list
        if (numberNickels > 0 || numberDimes > 0 || numberQuarters > 0 || numberDollars > 0) cout << ", ";
